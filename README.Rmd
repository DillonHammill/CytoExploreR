...
[![AppVeyor build status](https://ci.appveyor.com/api/projects/status/github/DillonHammill/CytoExploreR?branch=master&svg=true)](https://ci.appveyor.com/project/DillonHammill/CytoExploreR)
...
Now that all the setup is complete, let's install all the necessary dependencies of **CytoExploreR**. From within RStudio, run the following in the console to install the latest versions of the [cytoverse](https://cytoverse.org/) packages from Bioconductor.
