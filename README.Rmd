...
+ Dimensionality reduction is gaining popularity for analysis of high dimensional cytometry data. In the `Dimension Reduction` vignette we will demonstrate the use of `cyto_map` to produce PCA, tSNE, UMAP and EmbedSOM maps of cytometry data.
