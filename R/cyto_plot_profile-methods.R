...
#' )
#' @export
setMethod(cyto_plot_profile, signature = "flowFrame", definition = function(x,
                                                                            channels = NULL,
                                                                            axes_trans = NULL,
                                                                            layout = NULL,
                                                                            title = NA, ...) {
  ...
  lapply(channels, function(channel) {
    cyto_plot(x = fr, channel = channel, axes_trans = axes_trans, title = NA, ...)
  })
...
#' )
#' @export
setMethod(cyto_plot_profile, signature = "flowSet", definition = function(x,
                                                                          channels = NULL,
                                                                          group_by = FALSE,
                                                                          axes_trans = NULL,
                                                                          title = NA,
...
#' )
#' @export
setMethod(cyto_plot_profile, signature = "GatingSet", definition = function(x,
                                                                            parent = NULL,
                                                                            channels = NULL,
                                                                            axes_trans = NULL, ...) {
  ...
  # Check channels
  channels <- cyto_channel_check(x = fs, channels = channels, plot = FALSE)
