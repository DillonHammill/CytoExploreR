...
#' data. To use your own custom transformations, simply supply a transformerList
#' object to the \code{axes_trans} argument.
#'
...
#'   used internally to transform the fluorescent channels of the samples.
...
cyto_spillover_compute.GatingSet <- function(x,
  ...
  # Reverse in transformations is fluorescent channels - data must be LINEAR
