...
#' @param theta set to 0 for exact.  If non-zero, then will use either Barnes
#'   Hut or FIt-SNE based on nbody_algo.  If Barnes Hut, then this determins the
#'   accuracy of BH approximation. Default 0.5.
...
#'   optimization tricks. 1 to do plain,vanilla gradient descent (useful for
#'   testing large exaggeration coefficients)
#' @param stop_early_exag_iter when to switch off early exaggeration. Default
#'   250.
...
#' @param K number of nearest neighbours to get when using fixed sigma. Default
#'   -30 (None).
#' @param initialization N x no_dims array to intialize the solution. Default:
#'   None.
#' @param data_path unknown
#' @param result_path unknown
...
#' @param fast_tsne_path unknown
#' @param nthreads unknown
