...
test_that("cyto_plot_compensation flowFrame method", {
  ...
  p <- function() cyto_plot_compensation(getData(gsc, "Single Cells")[[1]],
                                         channel = "7-AAD-A",
                                         axes_trans = trns,
                                         compensate = TRUE, 
                                         overlay = transform(getData(gsc, "Single Cells")[[4]], trns))
  
  expect_doppelganger("cyto_plot_compensation-fr1", p)
  
  p <- function() cyto_plot_compensation(getData(gsc, "Single Cells")[[5]],
                                         channel = "PE-Cy7-A",
                                         axes_trans = trns,
                                         compensate = TRUE,
...
test_that("cyto_plot_compensation flowSet method", {
  ...
  p <- function() cyto_plot_compensation(getData(gsc[c(1,4)], "Single Cells"),
  ...
  p <- function() cyto_plot_compensation(getData(gsc[c(4,5)], "Single Cells"),
                                         channel_match = "Compensation-channels.csv",
                                         axes_trans = trns,
                                         compensate = TRUE,
                                         spillover = "Ref-Spillover-Matrix.csv")
...
test_that("cyto_plot_compensation GatingSet method", {
  ...
  p <- function() cyto_plot_compensation(gsc[c(1,4)],
                                         channel_match = "Compensation-channels.csv",
                                         axes_trans = trns,
                                         compensate = TRUE)
  ...
  p <- function() cyto_plot_compensation(gsc[c(4,5)],
                                         channel_match = "Compensation-channels.csv",
                                         axes_trans = trns,
                                         compensate = TRUE,
                                         spillover = "Ref-Spillover-Matrix.csv")
